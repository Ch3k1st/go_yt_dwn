...
DASH проверен отдельным стендом (`manifest.mpd` на 1280×720 и 640×360, аудио
отдельной `AdaptationSet`): расширение разобрало обе `Representation`, в списке
появилось `Лучшее · 720p · 2.4 Мбит · 360p · 700 кбит`, выбор `360p` дал файл
640×360 (1 812 367 Б). Длительность 0:20 прочиталась из
